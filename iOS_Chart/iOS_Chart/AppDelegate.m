...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UINavigationController *navc = [[UINavigationController alloc]initWithRootViewController:[[ChartListViewController alloc]init]];
    navc.interactivePopGestureRecognizer.delegate = (id)navc;
    navc.navigationBar.translucent = NO;
    self.window.rootViewController = navc;
    [self.window makeKeyAndVisible];
    
    [[LaunchAnimate initLauchView] startAnimation];
